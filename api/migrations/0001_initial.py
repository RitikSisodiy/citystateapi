    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wikiDataId', models.CharField(blank=True, max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Country',
        ...
        migrations.AddField(
            model_name='city',
            name='country',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='city', to='api.country'),
        ),
        migrations.AddField(
            model_name='city',
            name='state',
